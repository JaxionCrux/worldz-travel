...
import { CreditCard, Smartphone, Apple, User, CalendarIcon, ShieldCheck } from 'lucide-react';
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    ...
                    >
                      <FormItem className="flex items-center space-x-3 space-y-0 bg-white/10 p-3 rounded-md border border-white/10">
                        <FormControl>
                          <RadioGroupItem value="card" />
                        </FormControl>
                        <FormLabel className="font-normal cursor-pointer flex items-center text-white">
                          <CreditCard className="mr-2 h-4 w-4 text-white/80" />
                      ...
                      <FormItem className="flex items-center space-x-3 space-y-0 bg-white/10 p-3 rounded-md border border-white/10">
                        ...
                        <FormLabel className="font-normal cursor-pointer flex items-center text-white">
                          <Apple className="mr-2 h-4 w-4 text-white/80" />
                          Apple Pay
                        </FormLabel>
                      </FormItem>
                      <FormItem className="flex items-center space-x-3 space-y-0 bg-white/10 p-3 rounded-md border border-white/10">
                        ...
                        <FormLabel className="font-normal cursor-pointer flex items-center text-white">
                          <Smartphone className="mr-2 h-4 w-4 text-white/80" />
                          Google Pay
                        </FormLabel>
                      </FormItem>
                    </RadioGroup>
